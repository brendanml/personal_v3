            ...
            <div className={`${glassBaseStyles} ${scrolled ? glassStyles : glassInactiveStyles}`}>
                ...
                <Popover>
                    <PopoverTrigger asChild>
                        <Button variant="ghost" size="icon" className={glassClickable} aria-label="Email">
                            <EmailIcon sx={{ fontSize: 26 }} />
                        </Button>
                    </PopoverTrigger>
                    <PopoverContent side="top" className="w-auto flex flex-col items-center gap-2">
                        <span className="text-sm text-muted-foreground">{socials?.email}</span>
                        <a
